...
export default function DatenschutzPage() {
  return (
    <main className="min-h-screen bg-gray-50 py-40">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 font-canto-bold">
              Datenschutzerklärung
            </h1>
          </div>
          
          <div className="space-y-8 text-gray-700 font-muli leading-relaxed">
            <div className="bg-[#f2eae5] p-6 rounded-xl border-l-4 border-[#e88906]">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Information zum Datenschutz auf der Webseite von Amelie Klein</h2>
              <p className="text-sm text-gray-600">gemäß Art. 13, 14 und 21 der Datenschutz-Grundverordnung (DSGVO)</p>
              <p className="mt-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">I. Geltungsbereich</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">II. Verantwortliche der Datenverarbeitung</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">III. Kontaktdaten des Datenschutzbeauftragten</h2>
              <p>Ein Datenschutzbeauftragter muss nicht bestellt werden.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">IV. Umfang, Zweck und Rechtsgrundlage der Verarbeitung bei Nutzung der Webseite</h2>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">1. Allgemein</h3>
              <p className="mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">2. Cookies</h3>
              <p>Es werden keine Cookies verwendet.</p>

              <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">3. Kontaktaufnahme</h3>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">V. Ihre Betroffenenrechte</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">VI. Ihr Widerspruchsrecht nach Art. 21 DSGVO</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">VII. Schlussbemerkungen</h2>
              <p className="mb-4">
