    ...
    <main className="min-h-screen bg-gray-50 py-40">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12">
          ...
          <div className="space-y-8 text-gray-700 font-muli">
            <section>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 2 Vertragsgegenstand</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 3 Vertragsschluss</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 4 Leistungserbringung</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 5 Mitwirkungspflichten des Kunden</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 6 Vergütung und Zahlungsbedingungen</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 7 Urheberrechte und Nutzungsrechte</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 8 Vertraulichkeit</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 9 Haftung</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">§ 10 Kündigung</h2>
              <p className="mb-4">
