        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 font-canto-bold">
                Kontaktieren Sie uns
              </h2>
              
              <div className="space-y-6 text-gray-700 font-muli">
                ...
                <div className="mt-8 space-y-6">
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-[#e88906]/5 to-[#cbaea5]/5 rounded-xl border border-[#e88906]/10">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#e88906] to-[#cbaea5] rounded-xl flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="text-[#e88906] hover:text-[#e88906]/80 transition-colors duration-200 font-medium"
                      >
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#e88906] focus:border-transparent transition-all duration-200 bg-white disabled:bg-gray-50 disabled:cursor-not-allowed"
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-[#e88906] to-[#cbaea5] text-white font-semibold py-4 px-6 rounded-xl hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none"
                >
                  {isSubmitting ? (
