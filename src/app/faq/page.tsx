...
function FAQItem({ faq, isOpen, onToggle }: { faq: typeof faqData[0], isOpen: boolean, onToggle: () => void }) {
  return (
    <div className="border-b border-gray-200 last:border-b-0">
      <button
        className="w-full py-6 px-0 text-left flex items-center justify-between hover:bg-gray-50/50 transition-colors duration-200"
        onClick={onToggle}
      >
        <h3 className="text-lg font-semibold text-gray-900 pr-4 font-canto-bold">
          {faq.question}
        </h3>
    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-700 mb-8 font-muli">
