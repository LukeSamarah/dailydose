...
export const metadata: Metadata = {
  title: 'Über uns',
  description: 'Lernen Sie Amelie Klein und das Team von Daily Dose of Content kennen. Professionelle Social Media Betreuung für mittelständische Unternehmen in Mönchengladbach.',
  openGraph: {
    title: 'Über uns - Daily Dose of Content',
    description: 'Lernen Sie Amelie Klein und das Team von Daily Dose of Content kennen. Wir schaffen Sichtbarkeit auf den sozialen Medien für mittelständische Unternehmen.',
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              {/* Pill Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#f2eae5] rounded-full text-sm font-medium text-gray-800">
              ...
              {/* Large Title */}
              <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-gray-900 leading-tight font-canto-bold">
                {hero.title}
              </h2>
              
              {/* Text Content */}
              <div className="space-y-4 text-lg leading-relaxed text-gray-600 font-muli">
                {hero.content.split('\n\n').map((paragraph, index) => (
              ...
              {/* Bottom Text */}
              <p className="text-gray-600 font-muli italic">
