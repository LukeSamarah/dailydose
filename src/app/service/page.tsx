      ...
      <div className="flex-1 lg:pr-8">
        <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 font-canto-bold">
              {step.title}
            </h3>
          </div>
          <p className="text-gray-600 leading-relaxed font-muli">
            {step.description}
          </p>
        </div>
      </div>
      ...
      <section className="py-20 sm:py-32 bg-gray-50 relative">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl font-canto-bold">
              Unser Prozess
            </h2>
            <p className="mt-4 text-lg text-gray-600 font-muli">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
            {services.map((service, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="group bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 hover:border-[#e88906]/20 transition-all duration-300 hover:shadow-lg relative"
                >
                  <div 
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 font-canto-bold">
                          {service.title}
                        </h3>
                      </div>
                    ...
                    {/* Expandable Content - Direkt im gleichen Container */}
                    <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                      isExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
                    }`}>
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        <p className="text-gray-600 font-muli">
                          {service.description}
                        </p>
                      </div>
                    </div>
