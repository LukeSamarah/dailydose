        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
          <div className={`lg:pt-4 ${isImageLeft ? 'lg:order-2' : ''}`}>
            <div className="lg:max-w-lg">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl font-canto-bold">
                {title}
              </h1>
              <div className="mt-8 text-lg leading-8 text-gray-600 font-muli">
                {content.split('\n\n').map((paragraph, index) => (
