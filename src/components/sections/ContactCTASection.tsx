  ...
  return (
    <section className={`py-20 sm:py-32 ${bgColor} relative`}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-[#e88906] to-[#cbaea5] rounded-3xl relative overflow-hidden">
          ...
          <div className="relative px-8 py-16 sm:px-16 sm:py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/kontakt"
                className="inline-flex items-center gap-3 px-8 py-4 bg-white text-[#e88906] font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105"
              >
