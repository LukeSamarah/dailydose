    ...
    <section className={`py-20 sm:py-32 ${bgColor} relative`}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl lg:text-5xl font-canto-bold">
            {title}
          </h2>
          <p className="mt-4 text-lg text-gray-600 font-muli max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div 
                key={index}
                className="group bg-white rounded-2xl border border-gray-100 hover:border-[#e88906]/20 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 p-8 text-center"
              >
                <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-[#e88906] to-[#cbaea5] flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  <IconComponent className="w-8 h-8 text-white" />
                </div>
                
                <h3 className="text-sm sm:text-lg md:text-xl font-semibold text-gray-900 font-canto-bold group-hover:text-[#e88906] transition-colors duration-200 text-center leading-tight break-words hyphens-auto">
                  {service.title}
                </h3>
              </div>
            )
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-600 font-muli mb-8">
