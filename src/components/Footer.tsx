...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#f2eae5] to-[#cbaea5] shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        {/* Bottom Bar */}
        <div className="mt-16 pt-8 border-t border-[#cbaea5]/40">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-sm text-black/60">
              &copy; {new Date().getFullYear()} Daily Dose of Content. Alle Rechte vorbehalten.
            </p>
            <div className="flex space-x-6 text-sm">
              <Link href="/datenschutz" className="text-black/60 hover:text-[#e88906] transition-colors flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
                Datenschutz
              </Link>
              <Link href="/impressum" className="text-black/60 hover:text-[#e88906] transition-colors flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
